...
> “
  ...
  换个鲜活的例子来说，就是几年前手机刚兴起的时候，全国成千上万的人都在用，但  有几个人知道自己的手机也有操作系统的？
...
[何为“好”？适合自己的才是最好的](http://tieba.baidu.com/p/1677342775)
...
\>(II+)Slackware：力图成为“UNIX风格”的Linux发行版本。它的软件包管理系统它不会解决依赖关系。
...
网友X：楼上2B不解释
网友Y：lss是水军，是nvidia的托
网友Z：cao尼你吗比lsss，老子的n卡烂的EB
lz:抱歉，打错了，是ati……
...
大部分时候，搜索引擎是最好的老师。
[google](http://74.125.71.106/)
[baidu](http://119.75.217.56/)
...
### 提问的艺术
[传送门](http://phorum.vbird.org/viewtopic.php?t=96)
...
sudo输密码不会回显，连`*`都没有，经常有人问这个问题。其实可以:
...
完全可以把下面这条命令作成快捷方式，然后双击即可打开一个root的文件管理器。[^1]

> gksudo nautilus

## FootNotes

[^1]:不同发行版不一样，有的是gksu，有的后面是thunar或pcmanfm
